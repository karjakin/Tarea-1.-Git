...
# Importar el módulo para cargar los datos MNIST
import mnist_loader  
""" 
Cargar los conjuntos de datos de entrenamiento, validación y prueba utilizando la 
función `load_data_wrapper` de mnist_loader.
"""
training_data, validation_data, test_data = mnist_loader.load_data_wrapper()
"""
Convertir el conjunto de datos de entrenamiento en una lista.
"""
training_data = list(training_data)
"""
Ejemplo de uso de la clase Network definida en network.py:
"""
import network  
"""
Crear una instancia de la clase Network con 784 neuronas en la capa de entrada,
30 en la capa oculta y 10 en la capa de salida.
"""
net = network.Network([784, 30, 10])
"""
Entrenar la red usando el Descenso de Gradiente Estocástico (SGD) con los siguientes parámetros:
- Conjunto de entrenamiento: training_data
- Número de épocas: 30
- Tamaño del mini-lote: 10
- Tasa de aprendizaje: 3.0
- Conjunto de prueba para la evaluación: test_data
"""
